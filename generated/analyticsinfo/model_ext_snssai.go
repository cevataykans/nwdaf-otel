...
// AssertExtSnssaiRequired checks if the required fields are not zero-ed
func AssertExtSnssaiRequired(obj ExtSnssai) error {
...
// AssertExtSnssaiConstraints checks if the values respects the defined constraints
func AssertExtSnssaiConstraints(obj ExtSnssai) error {
	if obj.Sst < 0 {
