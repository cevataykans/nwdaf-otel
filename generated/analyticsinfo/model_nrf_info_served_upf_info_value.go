...
// AssertNrfInfoServedUpfInfoValueRequired checks if the required fields are not zero-ed
func AssertNrfInfoServedUpfInfoValueRequired(obj NrfInfoServedUpfInfoValue) error {
...
// AssertNrfInfoServedUpfInfoValueConstraints checks if the values respects the defined constraints
func AssertNrfInfoServedUpfInfoValueConstraints(obj NrfInfoServedUpfInfoValue) error {
	for _, el := range obj.SNssaiUpfInfoList {
