...
// AssertChfInfoRequired checks if the required fields are not zero-ed
func AssertChfInfoRequired(obj ChfInfo) error {
...
// AssertChfInfoConstraints checks if the values respects the defined constraints
func AssertChfInfoConstraints(obj ChfInfo) error {
	for _, el := range obj.SupiRangeList {
