...
// AssertRedundantTransmissionExpInfoConstraints checks if the values respects the defined constraints
func AssertRedundantTransmissionExpInfoConstraints(obj RedundantTransmissionExpInfo) error {
	if err := AssertNetworkAreaInfoConstraints(obj.SpatialValidCon); err != nil {
		return err
	}
	for _, el := range obj.RedTransExps {
		if err := AssertRedundantTransmissionExpPerTsConstraints(el); err != nil {
			return err
		}
	}
	return nil
