...
// AssertContextDataConstraints checks if the values respects the defined constraints
func AssertContextDataConstraints(obj ContextData) error {
	for _, el := range obj.ContextElems {
		if err := AssertContextElementConstraints(el); err != nil {
			return err
		}
	}
	return nil
