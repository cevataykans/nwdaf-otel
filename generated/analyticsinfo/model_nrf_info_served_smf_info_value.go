...
// AssertNrfInfoServedSmfInfoValueRequired checks if the required fields are not zero-ed
func AssertNrfInfoServedSmfInfoValueRequired(obj NrfInfoServedSmfInfoValue) error {
...
// AssertNrfInfoServedSmfInfoValueConstraints checks if the values respects the defined constraints
func AssertNrfInfoServedSmfInfoValueConstraints(obj NrfInfoServedSmfInfoValue) error {
	for _, el := range obj.SNssaiSmfInfoList {
