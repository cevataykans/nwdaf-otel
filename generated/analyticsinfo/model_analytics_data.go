...
// AssertAnalyticsDataConstraints checks if the values respects the defined constraints
func AssertAnalyticsDataConstraints(obj AnalyticsData) error {
	if err := AssertAnalyticsMetadataInfoConstraints(obj.AnaMetaInfo); err != nil {
		return err
	}
	for _, el := range obj.SliceLoadLevelInfos {
		if err := AssertSliceLoadLevelInformationConstraints(el); err != nil {
			return err
		}
	}
	for _, el := range obj.NsiLoadLevelInfos {
