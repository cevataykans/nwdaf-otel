...
// AssertTngfInfoRequired checks if the required fields are not zero-ed
func AssertTngfInfoRequired(obj TngfInfo) error {
...
// AssertTngfInfoConstraints checks if the values respects the defined constraints
func AssertTngfInfoConstraints(obj TngfInfo) error {
	for _, el := range obj.Ipv6EndpointAddresses {
