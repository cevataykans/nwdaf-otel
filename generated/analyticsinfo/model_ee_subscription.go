...
// AssertEeSubscriptionRequired checks if the required fields are not zero-ed
func AssertEeSubscriptionRequired(obj EeSubscription) error {
...
// AssertEeSubscriptionConstraints checks if the values respects the defined constraints
func AssertEeSubscriptionConstraints(obj EeSubscription) error {
	if err := AssertReportingOptionsConstraints(obj.ReportingOptions); err != nil {
		return err
	}
	if err := AssertContextInfoConstraints(obj.ContextInfo); err != nil {
		return err
	}
	return nil
}
