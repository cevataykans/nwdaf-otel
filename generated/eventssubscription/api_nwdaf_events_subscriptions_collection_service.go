...
// This service should implement the business logic for every endpoint for the NWDAFEventsSubscriptionsCollectionAPI API.
...
func NewNWDAFEventsSubscriptionsCollectionAPIService() *NWDAFEventsSubscriptionsCollectionAPIService {
...
func (s *NWDAFEventsSubscriptionsCollectionAPIService) CreateNWDAFEventsSubscription(ctx context.Context, nnwdafEventsSubscription NnwdafEventsSubscription) (ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(201, NnwdafEventsSubscription{}) or use other options such as http.Ok ...
	// return Response(201, NnwdafEventsSubscription{}), nil
