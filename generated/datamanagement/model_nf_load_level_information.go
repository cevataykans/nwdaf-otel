...
// AssertNfLoadLevelInformationConstraints checks if the values respects the defined constraints
func AssertNfLoadLevelInformationConstraints(obj NfLoadLevelInformation) error {
