...
// AssertNrfInfoRequired checks if the required fields are not zero-ed
func AssertNrfInfoRequired(obj NrfInfo) error {
	return nil
}

// AssertNrfInfoConstraints checks if the values respects the defined constraints
func AssertNrfInfoConstraints(obj NrfInfo) error {
	return nil
}
