...
// AssertPrevSubInfoRequired checks if the required fields are not zero-ed
func AssertPrevSubInfoRequired(obj PrevSubInfo) error {
	...
	for _, el := range obj.NfAnaEvents {
		if err := AssertNwdafEventRequired(el); err != nil {
			return err
		}
	}
	for _, el := range obj.UeAnaEvents {
...
// AssertPrevSubInfoConstraints checks if the values respects the defined constraints
func AssertPrevSubInfoConstraints(obj PrevSubInfo) error {
	for _, el := range obj.NfAnaEvents {
