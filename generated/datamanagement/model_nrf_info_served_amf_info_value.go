...
// AssertNrfInfoServedAmfInfoValueRequired checks if the required fields are not zero-ed
func AssertNrfInfoServedAmfInfoValueRequired(obj NrfInfoServedAmfInfoValue) error {
...
// AssertNrfInfoServedAmfInfoValueConstraints checks if the values respects the defined constraints
func AssertNrfInfoServedAmfInfoValueConstraints(obj NrfInfoServedAmfInfoValue) error {
	for _, el := range obj.GuamiList {
