...
// AssertSeppInfoRequired checks if the required fields are not zero-ed
func AssertSeppInfoRequired(obj SeppInfo) error {
...
// AssertSeppInfoConstraints checks if the values respects the defined constraints
func AssertSeppInfoConstraints(obj SeppInfo) error {
	for _, el := range obj.RemotePlmnList {
