...
func (s *SubscriptionsCollectionAPIService) CreateIndividualSubcription(ctx context.Context, nnwdafDataManagementSubsc *NnwdafDataManagementSubsc) (ImplResponse, error) {
