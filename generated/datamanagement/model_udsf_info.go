...
// AssertUdsfInfoRequired checks if the required fields are not zero-ed
func AssertUdsfInfoRequired(obj UdsfInfo) error {
...
// AssertUdsfInfoConstraints checks if the values respects the defined constraints
func AssertUdsfInfoConstraints(obj UdsfInfo) error {
	for _, el := range obj.SupiRanges {
