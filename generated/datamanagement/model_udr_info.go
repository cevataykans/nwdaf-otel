...
// AssertUdrInfoRequired checks if the required fields are not zero-ed
func AssertUdrInfoRequired(obj UdrInfo) error {
...
// AssertUdrInfoConstraints checks if the values respects the defined constraints
func AssertUdrInfoConstraints(obj UdrInfo) error {
	for _, el := range obj.SupiRanges {
