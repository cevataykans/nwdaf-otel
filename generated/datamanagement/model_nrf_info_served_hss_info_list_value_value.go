...
// AssertNrfInfoServedHssInfoListValueValueRequired checks if the required fields are not zero-ed
func AssertNrfInfoServedHssInfoListValueValueRequired(obj NrfInfoServedHssInfoListValueValue) error {
...
// AssertNrfInfoServedHssInfoListValueValueConstraints checks if the values respects the defined constraints
func AssertNrfInfoServedHssInfoListValueValueConstraints(obj NrfInfoServedHssInfoListValueValue) error {
	for _, el := range obj.ImsiRanges {
