...
CLIENT_CSV = f"grafana_data/dec12/ScalingWithLowTraffic-45s.csv"
...
def main():
    ...
    #     fontsize=8
    # )
    plt.legend(framealpha=0.5, fontsize=7.5, loc='upper left')
    plt.tight_layout()

    # plt.savefig(f"{NF.lower()}_endpoint_latencies.png", dpi=300)
    plt.savefig(f"latency_scaling_endpoint_latencies_low_traffic_2.png", dpi=300)
