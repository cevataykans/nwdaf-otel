...
func NewIndividualNWDAFEventSubscriptionTransferDocumentAPIService() *IndividualNWDAFEventSubscriptionTransferDocumentAPIService {
...
func (s *IndividualNWDAFEventSubscriptionTransferDocumentAPIService) UpdateNWDAFEventSubscriptionTransfer(ctx context.Context, transferId string, analyticsSubscriptionsTransfer eventssubscriptionAPI.AnalyticsSubscriptionsTransfer) (eventssubscriptionAPI.ImplResponse, error) {
	...
	return eventssubscriptionAPI.Response(http.StatusNotImplemented, nil), errors.New("UpdateNWDAFEventSubscriptionTransfer method not implemented")
}

// DeleteNWDAFEventSubscriptionTransfer - Delete an existing Individual NWDAF Event Subscription Transfer
func (s *IndividualNWDAFEventSubscriptionTransferDocumentAPIService) DeleteNWDAFEventSubscriptionTransfer(ctx context.Context, transferId string) (eventssubscriptionAPI.ImplResponse, error) {
	...
	return eventssubscriptionAPI.Response(http.StatusNotImplemented, nil), errors.New("DeleteNWDAFEventSubscriptionTransfer method not implemented")
}
