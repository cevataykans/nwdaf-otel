...
func NewIndividualNWDAFEventsSubscriptionDocumentAPIService() *IndividualNWDAFEventsSubscriptionDocumentAPIService {
...
func (s *IndividualNWDAFEventsSubscriptionDocumentAPIService) UpdateNWDAFEventsSubscription(ctx context.Context, subscriptionId string, nnwdafEventsSubscription eventssubscriptionAPI.NnwdafEventsSubscription) (eventssubscriptionAPI.ImplResponse, error) {
	...
	return eventssubscriptionAPI.Response(http.StatusNotImplemented, nil), errors.New("UpdateNWDAFEventsSubscription method not implemented")
}

// DeleteNWDAFEventsSubscription - Delete an existing Individual NWDAF Events Subscription
func (s *IndividualNWDAFEventsSubscriptionDocumentAPIService) DeleteNWDAFEventsSubscription(ctx context.Context, subscriptionId string) (eventssubscriptionAPI.ImplResponse, error) {
	// TODO - update DeleteNWDAFEventsSubscription with the required logic for this service method.
	// Add api_individual_nwdaf_events_subscription_document_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return eventssubscriptionAPI.Response(http.StatusNotImplemented, nil), errors.New("DeleteNWDAFEventsSubscription method not implemented")
}
