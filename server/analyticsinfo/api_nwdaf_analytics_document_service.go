...
func NewNWDAFAnalyticsDocumentAPIService() *NWDAFAnalyticsDocumentAPIService {
	return &NWDAFAnalyticsDocumentAPIService{}
}

// GetNWDAFAnalytics - Read a NWDAF Analytics
func (s *NWDAFAnalyticsDocumentAPIService) GetNWDAFAnalytics(ctx context.Context, eventId analyticsinfoAPI.EventId, anaReq analyticsinfoAPI.EventReportingRequirement, eventFilter analyticsinfoAPI.EventFilter, supportedFeatures string, tgtUe analyticsinfoAPI.TargetUeInformation) (analyticsinfoAPI.ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(500, ProblemDetailsAnalyticsInfoRequest{}) or use other options such as http.Ok ...
	// return Response(500, ProblemDetailsAnalyticsInfoRequest{}), nil
	...
	return analyticsinfoAPI.Response(http.StatusNotImplemented, nil), errors.New("GetNWDAFAnalytics method not implemented")
}
