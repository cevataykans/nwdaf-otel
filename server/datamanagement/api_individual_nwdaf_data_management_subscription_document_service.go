...
func (s *IndividualNWDAFDataManagementSubscriptionDocumentAPIService) UpdateNWDAFDataSubscription(ctx context.Context, subscriptionId string, nnwdafDataManagementSubsc *datamanagementAPI.NnwdafDataManagementSubsc) (datamanagementAPI.ImplResponse, error) {
	...
	return datamanagementAPI.Response(http.StatusNotImplemented, nil), errors.New("UpdateNWDAFDataSubscription method not implemented")
}

// DeleteNWDAFDataSubscription - unsubscribe from notifications
func (s *IndividualNWDAFDataManagementSubscriptionDocumentAPIService) DeleteNWDAFDataSubscription(ctx context.Context, subscriptionId string) (datamanagementAPI.ImplResponse, error) {
	...
	return datamanagementAPI.Response(http.StatusNotImplemented, nil), errors.New("DeleteNWDAFDataSubscription method not implemented")
}
