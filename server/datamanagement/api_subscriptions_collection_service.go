...
func NewSubscriptionsCollectionAPIService() *SubscriptionsCollectionAPIService {
	return &SubscriptionsCollectionAPIService{}
}

// CreateIndividualSubcription - subscribe to notifications
func (s *SubscriptionsCollectionAPIService) CreateIndividualSubcription(ctx context.Context, nnwdafDataManagementSubsc *datamanagementAPI.NnwdafDataManagementSubsc) (datamanagementAPI.ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(201, NnwdafDataManagementSubsc{}) or use other options such as http.Ok ...
	// return Response(201, NnwdafDataManagementSubsc{}), nil
	...
	return datamanagementAPI.Response(http.StatusNotImplemented, nil), errors.New("CreateIndividualSubcription method not implemented")
}
