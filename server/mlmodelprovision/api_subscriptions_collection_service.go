...
func (s *SubscriptionsCollectionAPIService) CreateNWDAFMLModelProvisionSubcription(ctx context.Context, nwdafMlModelProvSubsc mlmodelprovisionAPI.NwdafMlModelProvSubsc) (mlmodelprovisionAPI.ImplResponse, error) {
	...
	return mlmodelprovisionAPI.Response(http.StatusNotImplemented, nil), errors.New("CreateNWDAFMLModelProvisionSubcription method not implemented")
}
